...
exports.getArguments = exports.setTypeFields = exports.getTypeFields = exports.nodeInterface = exports.addType = exports.getTypes = exports.getType = exports.GraphQLBuffer = exports.GraphQLGeneric = exports.GraphQLDate = exports.GraphQLViewer = undefined;
...
function getArguments(type) {
  ...
  return (0, _lodash.reduce)(fields, function (args, field) {
    ...
    if (field.type instanceof _type.GraphQLObjectType) {
      args[field.name] = {
        name: field.name,
        type: new _type.GraphQLList(_type.GraphQLID)
      };
    }
...
function getType(graffitiModels, _ref2) {
  ...
  var graphQLTypeFields = (0, _lodash.reduce)(fields, function (graphQLFields, _ref3, key) {
    ...
    if (type === 'Array') {
      ...
      var nestedObjectName = getTypeFieldName(graphQLType.name, name);
      graphQLField.type = getType(graffitiModels, { name: nestedObjectName, description: description, fields: _fields2 }, newPath, rootType);
    } else {
...
exports.GraphQLBuffer = _buffer2.default;
